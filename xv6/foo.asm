...
int main(int argc, char *argv[]) {
  ...
  1c:	0f 8f 8a 00 00 00    	jg     ac <main+0xac>
	else
		n = atoi(argv[1]);
	if(n < 0 || n > 20)
		n = 2;
  ...
  24:	bf 01 00 00 00       	mov    $0x1,%edi
		d = 1.0;
  29:	dd 5d e0             	fstpl  -0x20(%ebp)
		n = 2;
  2c:	31 f6                	xor    %esi,%esi
  2e:	eb 28                	jmp    58 <main+0x58>
	id = 0;
	for(k = 0; k < n; ++k) {
		id = fork();
		if(id < 0)
  ...
  30:	0f 84 b6 00 00 00    	je     ec <main+0xec>
			printf(1, "Parent %d creating child %d\n", getpid(), id);
  36:	e8 d8 03 00 00       	call   413 <getpid>
  3b:	53                   	push   %ebx
	for(k = 0; k < n; ++k) {
  3c:	83 c6 01             	add    $0x1,%esi
			printf(1, "Parent %d creating child %d\n", getpid(), id);
  3f:	50                   	push   %eax
  40:	68 ac 08 00 00       	push   $0x8ac
  45:	6a 01                	push   $0x1
  47:	e8 e4 04 00 00       	call   530 <printf>
			wait();
  4c:	e8 4a 03 00 00       	call   39b <wait>
  51:	83 c4 10             	add    $0x10,%esp
	for(k = 0; k < n; ++k) {
  54:	39 f7                	cmp    %esi,%edi
  56:	7e 30                	jle    88 <main+0x88>
		id = fork();
  58:	e8 2e 03 00 00       	call   38b <fork>
  5d:	89 c3                	mov    %eax,%ebx
		if(id < 0)
  5f:	85 c0                	test   %eax,%eax
  61:	79 cd                	jns    30 <main+0x30>
			printf(1, "%d failed in fork!\n", getpid());
  63:	e8 ab 03 00 00       	call   413 <getpid>
  68:	83 ec 04             	sub    $0x4,%esp
	for(k = 0; k < n; ++k) {
  6b:	83 c6 01             	add    $0x1,%esi
			printf(1, "%d failed in fork!\n", getpid());
  6e:	50                   	push   %eax
  6f:	68 98 08 00 00       	push   $0x898
  74:	6a 01                	push   $0x1
  76:	e8 b5 04 00 00       	call   530 <printf>
  7b:	83 c4 10             	add    $0x10,%esp
	for(k = 0; k < n; ++k) {
  7e:	39 f7                	cmp    %esi,%edi
  80:	7f d6                	jg     58 <main+0x58>
  ...
  8b:	6a 64                	push   $0x64
  8d:	e8 d1 03 00 00       	call   463 <setprio>
	printf(1, "\n\n%d\n\n", getprio());
  92:	e8 d4 03 00 00       	call   46b <getprio>
  97:	83 c4 0c             	add    $0xc,%esp
  9a:	50                   	push   %eax
  9b:	68 db 08 00 00       	push   $0x8db
  a0:	6a 01                	push   $0x1
  a2:	e8 89 04 00 00       	call   530 <printf>
	exit();
  a7:	e8 e7 02 00 00       	call   393 <exit>
		n = atoi(argv[1]);
  ac:	83 ec 0c             	sub    $0xc,%esp
  af:	ff 76 04             	pushl  0x4(%esi)
  b2:	e8 69 02 00 00       	call   320 <atoi>
	if(n < 0 || n > 20)
  b7:	83 c4 10             	add    $0x10,%esp
		n = atoi(argv[1]);
  ba:	89 c7                	mov    %eax,%edi
	if(n < 0 || n > 20)
  bc:	83 f8 14             	cmp    $0x14,%eax
  bf:	76 6a                	jbe    12b <main+0x12b>
	if(argc < 3)
  c1:	83 fb 02             	cmp    $0x2,%ebx
  c4:	7e 56                	jle    11c <main+0x11c>
		n = 2;
  c6:	bf 02 00 00 00       	mov    $0x2,%edi
		d = atoi(argv[2]);
  cb:	83 ec 0c             	sub    $0xc,%esp
  ce:	ff 76 08             	pushl  0x8(%esi)
  d1:	e8 4a 02 00 00       	call   320 <atoi>
  d6:	83 c4 10             	add    $0x10,%esp
  d9:	89 45 e0             	mov    %eax,-0x20(%ebp)
  dc:	db 45 e0             	fildl  -0x20(%ebp)
  df:	dd 5d e0             	fstpl  -0x20(%ebp)
	for(k = 0; k < n; ++k) {
  e2:	85 ff                	test   %edi,%edi
  e4:	0f 85 42 ff ff ff    	jne    2c <main+0x2c>
  ea:	eb 9c                	jmp    88 <main+0x88>
			printf(1, "Child %d created\n", getpid());
  ec:	e8 22 03 00 00       	call   413 <getpid>
  f1:	52                   	push   %edx
  f2:	50                   	push   %eax
  f3:	68 c9 08 00 00       	push   $0x8c9
  f8:	6a 01                	push   $0x1
 ...
 108:	dc 45 e0             	faddl  -0x20(%ebp)
 10b:	d9 05 e4 08 00 00    	flds   0x8e4
 111:	df f1                	fcomip %st(1),%st
 113:	77 f3                	ja     108 <main+0x108>
 115:	dd d8                	fstp   %st(0)
 117:	e9 6c ff ff ff       	jmp    88 <main+0x88>
		d = 1.0;
 11c:	d9 e8                	fld1   
		n = 2;
 11e:	bf 02 00 00 00       	mov    $0x2,%edi
		d = 1.0;
 123:	dd 5d e0             	fstpl  -0x20(%ebp)
 126:	e9 01 ff ff ff       	jmp    2c <main+0x2c>
	if(argc < 3)
 12b:	83 fb 02             	cmp    $0x2,%ebx
 12e:	75 9b                	jne    cb <main+0xcb>
		d = 1.0;
 130:	d9 e8                	fld1   
 132:	dd 5d e0             	fstpl  -0x20(%ebp)
 135:	eb ab                	jmp    e2 <main+0xe2>
...
printf(int fd, char *fmt, ...)
{
 ...
 6b4:	eb 1a                	jmp    6d0 <printf+0x1a0>
          s = "(null)";
 6b6:	bb e8 08 00 00       	mov    $0x8e8,%ebx
        while(*s != 0){
 ...
 701:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 a0 0b 00 00    	mov    %edx,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e7:	73 4f                	jae    838 <malloc+0xa8>
    ...
    if(p == freep)
 7e9:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 812:	e8 e9 fe ff ff       	call   700 <free>
  return freep;
 817:	a1 a0 0b 00 00       	mov    0xba0,%eax
 ...
 844:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 847:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 ...
 85e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 867:	0b 00 00 
    base.s.size = 0;
 86a:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 876:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 87b:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 882:	00 00 00 
    if(p->s.size >= nunits){
