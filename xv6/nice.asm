...
main(int argc, char *argv[]) {
  ...
  22:	6a 02                	push   $0x2
  24:	e8 47 04 00 00       	call   470 <printf>
    exit();
  ...
  71:	53                   	push   %ebx
  72:	56                   	push   %esi
  73:	e8 0b 03 00 00       	call   383 <chpr>
  exit();
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 1c 08 00 00       	mov    $0x81c,%ebx
        while(*s != 0){
 ...
 641:	a1 d0 0a 00 00       	mov    0xad0,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 d0 0a 00 00    	mov    %edx,0xad0
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 d0 0a 00 00    	mov    %edx,0xad0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d d0 0a 00 00    	mov    0xad0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 727:	73 4f                	jae    778 <malloc+0xa8>
    ...
    if(p == freep)
 729:	8b 3d d0 0a 00 00    	mov    0xad0,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 d0 0a 00 00       	mov    0xad0,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 ...
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf d4 0a 00 00       	mov    $0xad4,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7c2:	00 00 00 
    if(p->s.size >= nunits){
