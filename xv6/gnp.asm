...
int main(void){
  ...
  11:	e8 25 03 00 00       	call   33b <getNumProc>
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb a0 07 00 00       	mov    $0x7a0,%ebx
        while(*s != 0){
 ...
 5f1:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
    p->s.size += bp->s.size;
